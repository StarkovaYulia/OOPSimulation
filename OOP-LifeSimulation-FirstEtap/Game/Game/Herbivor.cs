...
namespace Herbivores
{
    public class Herbivor : Animal
    {
        ...
        private void CreateKindOfAnimalSecond(int kind)
        {
            ...
            {
                case 0:
                    Cow cow = new Cow(map, locality);
                    cow.CreateKind();
                    break;
                case 1:
                    Gopher gopher = new Gopher(map, locality);
                    gopher.CreateKind();
                    break;
                case 2:
                    Goat goat = new Goat(map, locality);
                    goat.CreateKind();
                    break;
            }
        }
        ...
        protected internal void CreateChild(int x, int y, string nameOfAnimal)//internal
        {
            int kindOfAnimal = -1;
            switch (nameOfAnimal)
            {
