...
namespace GeneratingAndDrawing
{
    public class GenerateAndDraw
    {
        ...
        public void DrawPixel(int x, int y)
        {
            ...
            {
                colorOfSquare = descriptionSquares[x, y].predator[0].color;
            }
            else if (descriptionSquares[x, y].omnivor.Count != 0)
            {
                colorOfSquare = descriptionSquares[x, y].omnivor[0].color;
            }
            else if (descriptionSquares[x, y].herbivor.Count != 0)
            {
                colorOfSquare = descriptionSquares[x, y].herbivor[0].color;
            }
        ...
        public void GenerateStart(GenerateAndDraw locality)
        {
